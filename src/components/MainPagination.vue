...
<template>
  <div class="pagination">
    ...
    <button class="action" :diabled="activePage === pages" @click="nextPage">Next</button>
  </div>
</template>
...
.pagination {
  ...
  .action {
    @apply rounded-md bg-slate-100 p-2 font-medium text-slate-700
            shadow-md hover:bg-slate-200 disabled:text-slate-400
            hover:disabled:bg-slate-100;
  }
  .page {
    @apply rounded-md bg-slate-100 p-2 font-medium text-slate-700
